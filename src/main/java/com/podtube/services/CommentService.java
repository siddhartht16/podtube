...
public class CommentService {
	...
	ResponseEntity<List<Comment>> findCommentsForPodcast(@PathVariable("podcastId") int podcastId) {
		...
		return new ResponseEntity<>(commentRepository.findAllByPodcast_IdOrderByCreatedOnDesc(podcast.getId()), HttpStatus.OK);
	}
	...
	ResponseEntity<List<Comment>> findCommentsForUser(@PathVariable("userId") int userId) {
		...
		return new ResponseEntity<>(commentRepository.findAllByUser_IdOrderByCreatedOnDesc(user.getId()), HttpStatus.OK);
	}
	...
	ResponseEntity<List<Comment>> deleteComment(HttpSession httpSession,
        ...
        List<Comment> comments = commentRepository.findAllByPodcast_IdOrderByCreatedOnDesc(podcast.getId());
